...
import com.fa.mastodon.util.CircleTransformation;
import com.keylesspalace.tusky.R;
import com.fa.mastodon.util.RoundedTransformation;
import com.fa.mastodon.interfaces.StatusActionListener;
import com.fa.mastodon.entity.Status;
import com.fa.mastodon.util.DateUtils;
import com.fa.mastodon.util.LinkHelper;
...
class StatusViewHolder extends RecyclerView.ViewHolder {
    ...
    private void setAvatar(String url) {
        ...
        if (PreferenceManager.getDefaultSharedPreferences(context).getBoolean("circularPics", true)) {
