...
import com.fa.mastodon.activity.MainActivity;
import com.keylesspalace.tusky.R;
import com.fa.mastodon.adapter.TimelineAdapter;
...
import com.fa.mastodon.util.TimelineReceiver;
...
public class TimelineFragment extends SFragment implements
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (composeButtonPresent()) {
            ...
            hideFab = preferences.getBoolean("fabHide", true);
